...
% Kein \onehalfspacing oder \setlength{\parskip} nötig, da von Klasse gesetzt
...
\begin{itemize}
    ...
    \item Umgebungsbedingungen (Wind, Luftwiderstand)
\end{itemize}

Nachdem das gesamte Wasser ausgestoßen ist, fliegt die Rakete im freien Fall weiter, bis sie schließlich wieder zu Boden sinkt. Ein Fallschirm kann zur sicheren Landung beitragen.
